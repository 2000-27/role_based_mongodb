...
update_status = "<h3> Hi, {} the status of '{}' is updated to  '{}'</h3>"
update_task_id = """<h3>Hi {} , your manager  updated
                    the status of  task-id = '{}'  to  '{} </h3>"""
...
accepted_mail = """ <h1>Congratulation </h1>
                   <p> <h3> <u> {}</u> </h3> your purposal is acceted by <u> '{}'</u>  admin of :-{} company
                        </p>
                    """


rejected_mail = """  <h3>hi {} </h3>
                   <p>  your purposal is rejected by <u> '{}'</u> admin of {} company
                        </p>
                    """
